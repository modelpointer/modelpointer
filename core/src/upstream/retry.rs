...
//
// This file is adapted from sgl-model-gateway/src/upstream/retry.rs in the
...
impl RetryExecutor {
        ...
        OnExhausted: FnMut(),
    {
        ...
        loop {
            ...
            on_backoff(delay, next_attempt, status_code);
    ...
    async fn test_execute_response_with_retry_success_path_and_hooks() {
        ...
        let response = RetryExecutor::execute_response_with_retry(
            ...
            |res, _attempt| !res.status().is_success(),
            {
                ...
                move |_delay, _next_attempt, _status_code| {
